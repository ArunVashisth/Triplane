        ...
        {selectedContinent === 'all' ? (
          ...
          <div className="packages-grid">
            {filteredPackages.map((pkg) => (
              <Link to={`/package/${pkg._id}`} key={pkg._id} className="package-card" style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                <div className="package-content">
                  ...
                  <div className="package-price">
                    from <span className="price-amount">₹{pkg.price * 200}</span>
                  </div>
                    ...
                    <div className="country-group">
                      ...
                      <div className="country-packages">
                        {countryGroups[currentSlide]?.packages.slice(0, 3).map((pkg) => (
                          <Link to={`/package/${pkg._id}`} key={pkg._id} className="country-package-card" style={{ textDecoration: 'none', color: 'inherit' }}>
